...
const SCENARIOS: Scenario[] = [
  {
    id: 'openai-chat',
    name: 'OpenAI Chat Load',
    description: '对 OpenAI 兼容接口发起并发聊天请求，测量吞吐量与延迟分布。',
    tag: 'LLM',
    color: 'primary',
    status: 'ready',
  },
  {
    id: 'nashiyard-fireworks',
    name: 'NashiYard Fireworks',
    description: '模拟 NashiYard 网关高并发流量，验证限流与熔断策略。',
    tag: 'Gateway',
    color: 'secondary',
    status: 'ready',
  },
  {
    id: 'polling',
    name: 'Polling System',
    description: '长轮询场景压测，检测连接保持与服务端推送性能。',
    tag: 'Realtime',
    color: 'warning',
    status: 'beta',
  },
  {
    id: 'smoke',
    name: 'Smoke Check',
    description: '快速冒烟测试，验证所有核心端点可达性与基础响应正确性。',
    tag: 'Health',
    color: 'default',
    status: 'soon',
  },
  ...
  return (
    <Box
      sx={{
        ...
        backgroundImage:
          'radial-gradient(ellipse 60% 40% at 80% 0%, rgba(34,211,238,0.1) 0%, transparent 60%)',
      }}
    >
      {/* Header */}
      <Box
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
          ...
          <Typography fontWeight={700} letterSpacing="-0.3px">
            YouziLoadLab
          </Typography>
        </Box>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          ...
          <Button onClick={onLogout} size="small" variant="outlined" sx={{ borderColor: 'rgba(255,255,255,0.15)' }}>
            退出
          </Button>
        </Box>
      </Box>
